...
plot './pendulum_sim.csv' using 1:3 title 'Velocity ' w l ls 1, \
     './pendulum_sim.csv' using 1:9 title 'Velocity Estimate' w l ls 2, \
     './pendulum_sim.csv' using 1:14 title 'Velocity Error' w l ls 5
